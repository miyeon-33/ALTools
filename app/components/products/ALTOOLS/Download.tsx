...
export default function Download() {
  ...
  return (
    <div className="pt-[80px] pb-[60px] max-md:px-[40px] max-md:pb-[60px] ">
      <div className="mx-auto max-w-[1120px] min-h-[200px] relative">
        <div className="min-h-[200px] grid-cols-[200px_1fr] grid-rows-[auto_auto] gap-[40px] grid">
          <span className="overflow-hidden row-span-2 w-[200px] h-[200px] flex justify-center items-center bg-[#f5f6f7] rounded-[20px] border border-[rgba(0,0,0,0.1)]">
            <img src="/images/400altools.png" />
          </span>
          <div className="col-start-2 col-end-3 row-start-1 row-end-2">
            <h2 className="text-[40px] font-bold break-keep text-gray-600">
              알툴즈 통합팩
            </h2>
            <p className="text-[20px] font-bold pt-[8px]">
              알툴즈의 모든 제품이 하나의 통합 패키지로!
            </p>
          </div>
          <div className="col-start-2 col-end-3 row-start-2 row-end-3 flex justify-start items-start gap-[10px]">
        ...
        <Link
          href="/adzero/intro"
          className="flex justify-between items-center w-full text-left text-[#fff] rounded-[7px] py-[20px] px-[32px] mt-[56px] bg-gradient-to-r from-[#f64] to-[#ff4a81]"
        >
          <h3 className="text-[20px] font-bold break-keep">
            광고없이 사용하고 싶다면? 지금 알툴즈 AD-ZERO 시작하세요!
          </h3>
          <em
            className="flex justify-center items-center text-[15px] font-bold
              after:w-[12px] after:h-[12px] after:inline-flex after:ml-[4px] after:bg-[url('/images/icons/after.svg')] after:bg-[0_0] after:bg-[100%_auto] after:bg-no-repeat"
          >
            알툴즈 AD ZERO 구독하기
          </em>
        </Link>
        <div className="mt-[60px] max-md:mt-[40px] max-md:w-full">
          <h3 className="text-[18px] font-semibold pb-[16px] text-gray-600">
            함께하면 좋은 알툴즈 바로가기
          </h3>
        ...
        <div className="absolute top-0 right-0 w-[240px] max-md:static max-md:w-auto max-md:mt-[40px]">
          <div
            className={`text-[18px] font-semibold mb-[16px] cursor-pointer hidden  text-gray-600 after:inline-block after:w-[16px] after:h-[16px] after:ml-[4px] after:bg-[url('/images/icons/toggle.svg')] max-md:flex max-md:items-center ${
